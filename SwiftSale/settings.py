"""
Django settings for SwiftSale project.
...
# Load environment variables from the .env file (if you happen to be using it)
load_dotenv()
...
# SECRET KEY Hidden: (Sensitive data)
...
WSGI_APPLICATION = 'SwiftSale.wsgi.application'
